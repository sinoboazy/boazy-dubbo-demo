...
public class RestUserServiceImpl implements RestUserService {
	...
	public String registerUser(User user) {
		...
		System.out.println("springboot.rest.user.username=" + (null != user ? user.getName() : null));
		System.out.println("springboot.rest.user.email=" + (null != user ? user.getEmail() : null));
		System.out.println("springboot.rest.user.tel=" + (null != user ? user.getTel() : null));
